...
prometheus.io/path: {{ include "dremio.executor.metricsPort" . }}
...
{{- $dremioTerminationGracePeriodSeconds := default 0 $.Values.executor.nodeLifecycleService.terminationGracePeriodSeconds }}
...
{{- $nodeLifecycleServiceConfig := $.Values.executor.nodeLifecycleService -}}
{{- if $nodeLifecycleServiceConfig.enabled -}}
{{- $dremioTerminationGracePeriodSeconds := default 5 $.Values.executor.nodeLifecycleService.terminationGracePeriodSeconds }}
