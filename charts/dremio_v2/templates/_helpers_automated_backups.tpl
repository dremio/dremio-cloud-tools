...
{{/*
Automated Back Ups - Dremio Heap Memory allocation
*/}}
{{- define "dremio.automatedBackups.heapMemory" -}}
{{ $heapMemory := default 4096 $.Values.masterCoordinator.automatedBackups.heapMemory }}
{{- $heapMemory -}}
{{- end -}}
