...
{{- $cloudCacheStorageClass := coalesce $engineConfiguration.cloudCache.storageClass $context.Values.executor.cloudCache.storageClass $engineConfiguration.storageClass $context.Values.executor.storageClass $context.Values.storageClass -}}
...
{{- $engineName := index . 1 -}}
{{- $engineConfiguration := default (dict) (get (default (dict) $context.Values.executor.engineOverride) $engineName) -}}
{{- $engineAnnotations := coalesce $engineConfiguration.annotation $context.Values.executor.annotations $context.Values.annotations -}}
